...
: "${BDD_PUBLIC_ORIGIN:?BDD_PUBLIC_ORIGIN is required}"
...
DCS_HEALTH_URL="${BDD_PUBLIC_ORIGIN}${DCS_API_BASE_PATH}/auth/login"
...
echo "Hydra issuer URL (HYDRA_ISSUER_URL): ${BDD_PUBLIC_ORIGIN}"
...
export BDD_DCS_BASE_URL="${BDD_PUBLIC_ORIGIN}${DCS_API_BASE_PATH}"
