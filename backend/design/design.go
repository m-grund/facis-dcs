...
var JWTAuth = JWTSecurity("jwt", func() {
	...
	Scope("System Contract Creator", "System-level contract creation")
	Scope("Contract Negotiator", "Negotiate contract terms")
	Scope("Contract Reviewer", "Review submitted contracts")
	Scope("System Contract Reviewer", "System-level contract review")
	Scope("Contract Approver", "Approve or reject contracts")
	Scope("System Contract Approver", "System-level contract approval")
	Scope("Contract Manager", "Manage contract lifecycle")
	Scope("System Contract Manager", "System-level contract management")
	Scope("Contract Signer", "Sign contracts digitally")
	Scope("System Contract Signer", "System-level contract signing")
