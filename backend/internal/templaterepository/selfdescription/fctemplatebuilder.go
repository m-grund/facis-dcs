...
func buildTemplateDataContext(version int, templateDataContextURL string) map[string]interface{} {
	...
	case 1:
		return map[string]interface{}{
			...
			"entityType":                "dcs-template-data:entityType",
			"entityRole":                "dcs-template-data:entityRole",
			...
			"schemaRef":                 "dcs-template-data:schemaRef",
			"semanticPath":              "dcs-template-data:semanticPath",
			"fixedValue":                "dcs-template-data:fixedValue",
